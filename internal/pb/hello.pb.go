...
const file_hello_proto_rawDesc = "" +
	...
	"\rBatchUsersReq\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\x03R\x03ids\"C\n" +
	"\x0fBatchUsersReply\x120\n" +
	"\x05users\x18\x01 \x03(\v2\x1a.App.Grpc.Hello.UserEntityR\x05users2\xa1\x02\n" +
	"\x0eGreeterService\x12V\n" +
	...
	"\x04Info\x12\x17.App.Grpc.Hello.InfoReq\x1a\x19.App.Grpc.Hello.InfoReply\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/info/{name}\x12b\n" +
	"\n" +
	"BatchUsers\x12\x1d.App.Grpc.Hello.BatchUsersReq\x1a\x1f.App.Grpc.Hello.BatchUsersReply\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/usersB\aZ\x05./;pbb\x06proto3"
