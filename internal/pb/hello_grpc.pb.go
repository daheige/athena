...
const (
	...
	GreeterService_Info_FullMethodName       = "/App.Grpc.Hello.GreeterService/Info"
	GreeterService_BatchUsers_FullMethodName = "/App.Grpc.Hello.GreeterService/BatchUsers"
)
...
type GreeterServiceClient interface {
	...
	BatchUsers(ctx context.Context, in *BatchUsersReq, opts ...grpc.CallOption) (*BatchUsersReply, error)
}
...
func (c *greeterServiceClient) Info(ctx context.Context, in *InfoReq, opts ...grpc.CallOption) (*InfoReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InfoReply)
	err := c.cc.Invoke(ctx, GreeterService_Info_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterServiceClient) BatchUsers(ctx context.Context, in *BatchUsersReq, opts ...grpc.CallOption) (*BatchUsersReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchUsersReply)
	err := c.cc.Invoke(ctx, GreeterService_BatchUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServiceServer interface {
	...
	BatchUsers(context.Context, *BatchUsersReq) (*BatchUsersReply, error)
...
func (UnimplementedGreeterServiceServer) BatchUsers(context.Context, *BatchUsersReq) (*BatchUsersReply, error) {
...
func _GreeterService_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreeterService_Info_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GreeterService_BatchUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchUsersReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServiceServer).BatchUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreeterService_BatchUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServiceServer).BatchUsers(ctx, req.(*BatchUsersReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GreeterService_BatchUsers_Handler,
		},
	},
